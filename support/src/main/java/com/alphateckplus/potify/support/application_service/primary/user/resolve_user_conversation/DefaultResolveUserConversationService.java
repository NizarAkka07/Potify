...
public class DefaultResolveUserConversationService implements ResolveUserConversationUseCase {
    ...
    @Override
    @Transactional
    public SupportConversationDto resolveConversation(String userEmail, String conversationId) {
        ...
        SupportMessage sysMsg = SupportMessage.builder()
                ...
                .content("✅ La conversation a été marquée comme résolue.")
