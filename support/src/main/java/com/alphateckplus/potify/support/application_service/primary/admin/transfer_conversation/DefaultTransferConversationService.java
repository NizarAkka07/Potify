...
public class DefaultTransferConversationService implements TransferConversationUseCase {
    ...
    @Override
    @Transactional
    public SupportConversationDto transferConversation(String currentAdminEmail, String conversationId, TransferConversationRequest request) {
        ...
        conversation.setAssignedAdminId(request.getTargetAdminId());
        conversation.setAssignedAdminName(request.getTargetAdminId());
        ...
        SupportMessage sysMsg = SupportMessage.builder()
                ...
                .content("🔄 Ticket transféré à " + conversation.getAssignedAdminName() + ". Motif: " + request.getReason())
